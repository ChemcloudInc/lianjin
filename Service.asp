...
<tr>
<td height="32" background="images/h1.jpg">&nbsp;<strong><font style="font-size:16px">Position： Home &gt; Special Service</font></strong>   </td>
</tr>
 
<tr>
<td style="padding:10px; font-size:12px; line-height:200%;"><%=conn.execute("select service from baseinfo")(0)%>
</td>
</tr>
</table></td>
</tr>
