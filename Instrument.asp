...
<tr>
<td height="32" background="images/h1.jpg">&nbsp;<strong><font style="font-size:16px">Position： Home &gt; Our Instrument</font></strong>   </td>
</tr>
<tr>
  <td height="32"><%=conn.execute("select instrument from baseinfo")(0)%></td>
</tr>
</table>
