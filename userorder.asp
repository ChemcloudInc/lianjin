...
<tr>
<td height="34" background="images/user6.jpg" class="padleft">Position：Home &gt; User &gt; Paid orders </td>
</tr>
</table>
<div class="con_k"></div>
...
<form name="form1" method="post" action="userorder.asp?action=search">
<tr align="center">
...
<td align="center" bgcolor="EEF7FF">Send Number </td>
</tr>
 <%
set rs=server.createobject("adodb.recordset")
if action="search" then
sql="select distinct ordernum,username,fkfs,shfs,receive_name,addtime,zhuangtai,orderflag,zonge from orders where orderflag=2 and username='"&request.Cookies("userloginname")&"'"
...
sql="select distinct ordernum,username,fkfs,shfs,receive_name,addtime,zhuangtai,orderflag,zonge,proid from orders where orderflag=2 and username='"&request.Cookies("userloginname")&"' order by zhuangtai desc,fkfs asc, addtime "&paixu&""
...
<tr>
  <td height="25" colspan="10" bgcolor="#FFFFFF">Nothing</td>
</tr>
<%
else
rs.pagesize=18
