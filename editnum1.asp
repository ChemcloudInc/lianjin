...
if orderid="" then
response.write "<script language=javascript>alert('对不起，您没有选择商品！');window.location.href='supergouwu.asp?action=show';</script>"
response.end 
end if
...
sql="select proid,proname,svipprice,vipprice,userprice,shuliang from product where proid="&request.form("proid")(i)
...
next
response.Redirect("supergouwu.asp?action=show")
%>
</body>
</html>
