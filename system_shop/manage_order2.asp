...
<form name="form2" method="post" action="manage_order2.asp?action=search">
<tr>
...
<td width="8%"><input name="username" type="text" id="username" size="12"></td>
<td width="7%">Begin：</td>
<td width="11%"> 
...
<td width="12%" height="25" background="images/titlebg.gif" bgcolor="#6699cc">Order Number</td>
<td width="18%" background="images/titlebg.gif" bgcolor="#6699cc">States</td>
<td width="20%" background="images/titlebg.gif" bgcolor="#6699cc">User Name</td>
<td width="10%" background="images/titlebg.gif" bgcolor="#6699cc">Payment method</td>
<td width="15%" background="images/titlebg.gif" bgcolor="#6699cc">Time</td>
<td width="14%" background="images/titlebg.gif" bgcolor="#6699cc">Operator</td>
<td width="11%" background="images/titlebg.gif" bgcolor="#6699cc">Operator</td>
</tr>
<%
...
'end if
sql="select distinct ordernum,zhuangtai,username,fkfs,addtime,admin_name,shren,orderflag from orders where orderflag=1 "
...
<td height="25">
<a href="javascript:;" onClick="javascript:window.open('view_order2.asp?ordernum=<%=rs("ordernum")%>','','width=550,height=400,toolbar=no, status=no, menubar=no, resizable=yes, scrollbars=yes');return false;">
<%=rs("ordernum")%></a></td>
<td height="25">
 <%=rs("zhuangtai")%>
<%=rzhuangtai%></td>
