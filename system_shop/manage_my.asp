...
<tr>
<td align="center" background="images/titlebg.gif">Order Number</td>
</tr>
...
<tr align="center">
<td width="10%" height="25">Order Number：</td>
<td width="10%"><input name="ordernum" type="text" id="ordernum" size="12"></td>
<td width="9%">Username：</td>
<td width="11%"><input name="username" type="text" id="username" size="12"></td>
<td width="7%">Begin：</td>
<td width="14%"><input name="qsrq" type="text" class="input" id="qsrq"onClick="new Calendar().show(this.form.qsrq);" size="15"></td>
<td width="6%">End：</td>
<td width="12%"><input name="jsrq" type="text" class="input" id="jsrq"onClick="new Calendar().show(this.form.jsrq);" size="15"></td>
<td width="6%">Operator：</td>
<td width="8%"><input name="admin_name" type="text" id="admin_name" size="12"></td>
<td width="7%">
...
<td width="10%" height="25" background="images/titlebg.gif" bgcolor="#6699cc">Order Number<a href="manage11.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="11%" background="images/titlebg.gif" bgcolor="#6699cc">States<a href="manage12.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="22%" background="images/titlebg.gif" bgcolor="#6699cc">Username<a href="manage13.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="12%" background="images/titlebg.gif" bgcolor="#6699cc">Payment method<a href="manage14.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="9%" background="images/titlebg.gif" bgcolor="#6699cc">Time<a href="manage15.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="13%" background="images/titlebg.gif" bgcolor="#6699cc">Operator</td>
<td width="12%" background="images/titlebg.gif" bgcolor="#6699cc">Operator<a href="manage16.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
<td width="11%" background="images/titlebg.gif" bgcolor="#6699cc">Audit person<a href="manage17.asp"><img src="../images/xia.jpg" width="12" height="6" border="0"></a></td>
</tr>
<%
...
%>
<tr>
<td colspan="8" bgcolor="#FFFFFF">Nothing</td>
</tr>
<%else
rs.pagesize=100
...
<%caozuoname=conn.execute("select username,caozuoname from webuser where username='"&trim(rs("username"))&"'")(1)%>

<%if request.Cookies("seomanager")("admin_name")=caozuoname then%>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
<tr align="center">
<td width="11%" height="25">Order Number：</td>
<td width="11%"><input name="ordernum" type="text" id="ordernum" size="12"></td>
