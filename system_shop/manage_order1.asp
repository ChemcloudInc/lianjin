...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="A4B6D7">
    <tr align="center" bgcolor="#6699cc">
      ...
      <td width="13%" background="images/titlebg.gif" bgcolor="#6699cc">Payment method</td>
      <td width="12%" background="images/titlebg.gif" bgcolor="#6699cc">Time</td>
...
'end if
sql="select distinct ordernum,zhuangtai,username,fkfs,addtime,admin_name,shren,orderflag from orders where orderflag=2    "
