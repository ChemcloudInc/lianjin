...
-->
</style><!--#include file="function.asp"-->
...
<tr>
<td width="130" height="45" align="center"><a href="index.asp"><strong><font color="#FFFFFF" style="font-size:14px">Home</font></strong></a></td>
